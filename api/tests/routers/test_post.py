...
async def test_get_comments_on_post(async_client: AsyncClient, created_post: dict, created_comment: dict):
    ...
    response = await async_client.get(f"/posts/post/{post_id}/comment")
...
async def test_get_post_with_comments(async_client: AsyncClient, created_post: dict, created_comment: dict):
    ...
    response = await async_client.get(f"/posts/post/{post_id}/comments")
...
async def test_get_missing_post_with_comments(async_client: AsyncClient):
    response = await async_client.get("/posts/post/999/comments")
